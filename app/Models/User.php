...
class User extends Authenticatable implements FilamentUser
{
    ...
    public function avatarUrl(): ?string
    {
        if ($this->hasVerification()) {
            ...
            $minecraftName = $userProfile->minecraft_name;
    ...
    public function hasVerification(): bool
    {
        ...
        if ($userProfile && $userProfile->minecraft_name && $userProfile->minecraft_id) {
            return true;
        }
    ...
    {
        return Cache::rememberForever("{$this->getCacheKey()}:".UserProfile::getClassName(), function () {
            return $this->profile;
        });
    }

	public function getLastSessionAttribute(): ?Session
	{
	...
	{
//		return Cache::rememberForever("{$this->getCacheKey()}:".Session::getClassName(), function () {
