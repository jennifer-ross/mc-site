...
{{--intersect-once--}}
<div class="flex justify-between mx-auto w-full my-28 px-4 sm:max-w-md sm:px-0 md:max-w-2xl lg:max-w-4xl xl:max-w-6xl transition-opacity intersect:motion-translate-y-in-75 intersect:motion-opacity-in-0 motion-delay-200">
